...
const MetricCard = (props: Props) => {
  ...
  // This assumes that the label passed is already a translation key
  // If not, we'll need to map the English labels to translation keys
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center justify-between mb-1 sm:mb-2 relative z-10">
        <p className="text-muted-foreground text-xs sm:text-sm truncate pr-2 font-medium">{translatedLabel}</p>
